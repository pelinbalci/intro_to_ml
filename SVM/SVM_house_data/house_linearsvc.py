...
models_lin = (LinearSVC(C=0.000001, max_iter=10000),
              LinearSVC(C=0.1, max_iter=10000),
              LinearSVC(C=1000, max_iter=10000),
              LinearSVC(C=1000000, max_iter=10000),
...
# title for the plots
titles_lin = ('SVC with linear kernel c=0.000001',
              'SVC with linear kernel c=0.1',
              'SVC with linear kernel c=1000',
              'SVC with linear kernel c=1000000',
...
print('linearSVC C=0.000001 score:', accuracy_score(y_test, pred_1))
print('linearSVC C=0.1  score:', accuracy_score(y_test, pred_2))
print('linearSVC C=1000  score: ', accuracy_score(y_test, pred_3))
print('linearSVC C=10000 score:', accuracy_score(y_test, pred_4))
