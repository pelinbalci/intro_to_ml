...
model_4 = SVC(kernel='poly', degree=5, gamma='auto', C=100)
...
print('kernel=poly, degree=2, gamma=auto, C=100 score: ', accuracy_score(y_test, pred_2))
print('kernel=poly, degree=5, gamma=auto, C=0.1 score: ', accuracy_score(y_test, pred_3))
print('kernel=poly, degree=5, gamma=auto, C=100 score: ', accuracy_score(y_test, pred_4))

'''
kernel=poly, degree=2, gamma=auto, C=0.1 score:  1.0
kernel=poly, degree=2, gamma=auto, C=100 score:  0.98
kernel=poly, degree=5, gamma=auto, C=0.1 score:  0.98
kernel=poly, degree=5, gamma=auto, C=100 score:  0.96
'''