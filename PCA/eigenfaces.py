# Ref: https://github.com/udacity/ud120-projects/blob/master/pca/eigenfaces.py
...
n_samples, h, w = lfw_people.images.shape  # n_samples = 1288 height = 50 width = 37
np.random.seed(42)

# for machine learning we use the data directly (as relative pixel
# position info is ignored by this model)
X = lfw_people.data  # 1288, 1850=50*37
n_features = X.shape[1]

# the label to predict is the id of the person
y = lfw_people.target  # 1288
target_names = lfw_people.target_names  # Ariel Sharon, George Bush, etc.
